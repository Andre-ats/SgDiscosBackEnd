...
namespace Domain.Utilitarios.Validador.Produto;

public class ProdutoValidador
{
    public Result<bool> Validar(
        string nomeProduto, 
        string nomeArtistaBandaProduto, 
        string descricaoProduto, 
        string? empresaProduto, 
        string? origemProduto,
        int? anoLancamentoProduto, 
        string codigoBarra, 
        EnumEmbalagemProduto embalagemProduto, 
        EnumFormatoProduto formatoProduto, 
        EnumTipoDeAlbum tipoDeAlbum, 
        List<EnumGeneroMusicalProduto> generoMusicalProdutos, 
        int? quantidadeDeCancoesProduto, 
        int quantidadeProduto, 
        decimal precoProduto, 
        EnumStatusProduto statusProduto, 
        EnumCondicao condicao, 
        int quantiaDiscos,
        decimal? precoDescontoProduto
    )
    {
        ...
        var camposDecimal = new (decimal? valor, string nome, decimal min, decimal max, bool obrigatorio)[]
        {
            ...
            (precoDescontoProduto, "Preço do Produto com Desconto", 1m, 10000m, false)
        };
